...
namespace ASE3040.Application.Tests.Common.Behaviours
{
    ...
    public class AuthorizationBehaviourTests
    {
        ...
        public async Task ShouldThrowExceptionIfNotAuthorized()
        {
            ...
            await Assert.ThrowsExceptionAsync<UnauthorizedAccessException>(() => behaviour.Handle(request, next, CancellationToken.None));
        }
        ...
        [Authorize]
        public class AuthorizedRequest : IRequest<Unit> { }

        public class NoAuthorizeAttributeRequest : IRequest<Unit> { }
    }
}
